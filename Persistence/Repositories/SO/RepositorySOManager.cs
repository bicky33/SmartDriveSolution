...
namespace Persistence.SO
{
    ...
    {
        private readonly Lazy<IRepositoryRelationSOBase<Service,int>> _serviceRepository;
        private readonly Lazy<IRepositorySOEntityBase<ServiceOrder,string>> _serviceOrderRepository;
        private readonly Lazy<IRepositoryRelationSOBase<ServiceOrderTask,int>> _serviceOrderTaskRepository;
        ...
        public RepositorySOManager(SmartDriveContext dbContext)
        {
            ...
            _serviceRepository = new Lazy<IRepositoryRelationSOBase<Service,int>>(()=>new ServiceRepository(dbContext));
            _serviceOrderRepository = new Lazy<IRepositorySOEntityBase<ServiceOrder,string>>(()=>new ServiceOrderRepository(dbContext));
            _serviceOrderTaskRepository = new Lazy<IRepositoryRelationSOBase<ServiceOrderTask,int>>(()=>new ServiceOrderTaskRepository(dbContext));
        ...
        public IRepositoryRelationSOBase<Service,int> ServiceRepository => _serviceRepository.Value;
        public IRepositorySOEntityBase<ServiceOrder,string> ServiceOrderRepository => _serviceOrderRepository.Value;
        public IRepositoryRelationSOBase<ServiceOrderTask,int> ServiceOrderTaskRepository => _serviceOrderTaskRepository.Value;
