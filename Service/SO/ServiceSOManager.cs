...
namespace Service.SO
{
    public class ServiceSOManager : IServiceSOManager
    {
        ...
        private readonly Lazy<IServiceSORelationBase<ServiceOrderTaskDto, ServiceOrderTaskDtoCreate, int>> _serviceOrderTaskService;
        ...
        {
            _serviceService = new Lazy<IServiceSORelationBase<ServiceDto,ServiceDtoCreate,int>>(()=> new ServiceService(repositoryManager));
            ...
            _serviceOrderTaskService = new Lazy<IServiceSORelationBase<ServiceOrderTaskDto, ServiceOrderTaskDtoCreate, int>>(()=> new ServiceOrderTaskService(repositoryManager));
        ...
        public IServiceSORelationBase<ServiceOrderTaskDto,ServiceOrderTaskDtoCreate, int> ServiceOrderTaskService => _serviceOrderTaskService.Value;
